...
L["If checked, the map will not fade while your character is moving."] = "勾选后，当你角色移动时，地图不再淡化。"
...
L["If checked, you will be able to move and scale the map.|n|nThe map position and scale will be saved separately for the maximised and windowed maps."] = "勾选后，你可以移动并缩放地图。|n|n地图的位置及缩放设置会分别为最大化和窗口化的地图保存。"
L["If checked, you will be able to move the frame by dragging the border."] = "勾选后，你可以点击边框来拖动地图。"
...
L["If checked, your character will not perform the reading emote when you open the map."] = "勾选后，当你打开地图时不再有阅读的表情动作。"
...
L["Set the map frame scale"] = "设置地图缩放"
...
L["Drag to set the scale for the maximised map."] = "拖拉來設定最大化地圖大小。"
L["Drag to set the scale for the windowed map."] = "拖拉來設定視窗化地圖大小。"
L["Dragon Soul"] = "巨龍之魂"
...
L["If checked, the map will not fade while your character is moving."] = "勾選後，當您角色移動時地圖不再淡出。"
...
L["If checked, you will be able to move and scale the map.|n|nThe map position and scale will be saved separately for the maximised and windowed maps."] = "勾選後，您將可以移動與縮放地圖。|n|n地圖位置與大小將會使用最大化與視窗化分開保存。"
...
L["If checked, your character will not perform the reading emote when you open the map."] = "勾選後，您的角色開啟地圖時不再出現閱讀表情。"
...
L["Set the map frame scale"] = "設定地圖框架大小"
...
L["Allow frame movement"] = "Разрешить движение окна"
L["Alpha"] = "Альфа"
...
L["Disable map fade"] = "Отключить исчезновение карты"
L["Disable reading emote"] = "Отключить чтение эмоций"
...
L["Drag to set the scale for the maximised map."] = "Перетащите, чтобы установить масштаб для развернутой карты."
L["Drag to set the scale for the windowed map."] = "Перетащите, чтобы установить масштаб для оконной карты."
...
L["Icons"] = "Иконки"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown."] = "Если флажок установлен, будут показаны порты, башни дирижабля."
L["If checked, coordinates will be shown."] = "Если отмечено, координаты будут показаны."
L["If checked, dungeons and raids will be shown."] = "Если отмечено, подземелья и рейды будут показаны."
L["If checked, flight points will be shown."] = "Если флажок установлен, будут показаны точки полета."
L["If checked, group icons will use a modern, class-colored design."] = "Если этот флажок установлен, значки групп будут использовать современный цветной дизайн."
L["If checked, opening the map will use the same zoom level from when you last closed it as long as the map zone has not changed."] = "Если этот флажок установлен, то при открытии карты будет использоваться тот же уровень масштабирования, что и при последнем закрытии карты, если зона карты не изменилась."
L["If checked, the map will not fade while your character is moving."] = "Если флажок установлен, карта не исчезнет, пока ваш персонаж движется."
L["If checked, the minimap button will be shown."] = "Если флажок установлен, будет показана кнопка на мини-карты."
L["If checked, unexplored areas of the map will be shown."] = "Если флажок установлен, будут отображаться неисследованные области карты."
L["If checked, unexplored areas will be tinted."] = "Если отмечено, неисследованные области будут окрашены."
L["If checked, you will be able to move and scale the map.|n|nThe map position and scale will be saved separately for the maximised and windowed maps."] = "Если установлен этот флажок, вы сможете перемещать и масштабировать карту.|n|nПоложение и масштаб карты будут сохраняться отдельно для развернутых и оконных карт."
L["If checked, you will be able to move the frame by dragging the border."] = "Если установлен этот флажок, вы сможете перемещать рамку, перетаскивая границу."
L["If checked, your character will not perform the reading emote when you open the map."] = "Если флажок установлен, ваш персонаж не будет выполнять эмоции чтения, когда вы открываете карту."
...
L["Set the map frame scale"] = "Установить масштаб окна карты"
...
L["Unlock Map"] = "Разблокировать карту"
...
L["Disable map fade"] = "지도 사라짐 사용안함"
L["Disable reading emote"] = "지도 보기 표현 사용안함"
...
L["Drag to set the scale for the maximised map."] = "최대화 된 지도의 배율을 설정합니다."
L["Drag to set the scale for the windowed map."] = "최소화 된 지도의 배율을 설정합니다."
L["Dragon Soul"] = "용의 영혼"
...
L["If checked, the map will not fade while your character is moving."] = "캐릭터가 움직일때 지도 사라짐이 작동하지 않습니다."
...
L["If checked, you will be able to move and scale the map.|n|nThe map position and scale will be saved separately for the maximised and windowed maps."] = "지도의 크기를 변경 하고 이동 할 수 있습니다. 최대 및 축소 된 지도의 위치와 크기를 별도로 저장합니다."
...
L["If checked, your character will not perform the reading emote when you open the map."] = "지도를 열때 캐릭터가 지도를 펼치는 표현을 하지 않습니다."
...
L["Set the map frame scale"] = "지도 크기 설정"
