...
-- English, the default
MONKEYQUEST_DESCRIPTION					= "显示你的任务监视"
MONKEYQUEST_LOADED_MSG					= MONKEYQUEST_INFO_COLOUR .. MONKEYQUEST_TITLE .. " v" .. MONKEYQUEST_VERSION .. " 已加载"
MONKEYQUEST_OPTIONS1					= "请安装MonkeyBuddy以轻松配置MonkeyQuest."
MONKEYQUEST_OPTIONS2					= "\124TInterface\\Icons\\Trade_Engineering:0\124t MonkeyBuddy is currently not installed."

MONKEYQUEST_NO_HEADER					= "无标题"
MONKEYQUEST_QUEST_DONE					= "完成"
MONKEYQUEST_QUEST_FAILED				= "失败"
MONKEYQUEST_CONFIRM_RESET				= "复位 " .. MONKEYQUEST_TITLE .. " 设置到默认?"
MONKEYQUEST_CONFIRM_RESET_TO_BLIZZARD_STYLE				= "设置 " .. MONKEYQUEST_TITLE .. " 设置为暴雪任务监视风格?"

MONKEYQUEST_SET_WIDTH_MSG				= MONKEYQUEST_CHAT_COLOUR .. MONKEYQUEST_TITLE .. ": 你需要使用 '/console reloadui' 看看宽度的变化."
MONKEYQUEST_RESET_MSG					= MONKEYQUEST_CHAT_COLOUR .. MONKEYQUEST_TITLE .. ": 重置."
MONKEYQUEST_RESET_TO_BLIZZARD_STYLE_MSG	= MONKEYQUEST_CHAT_COLOUR .. MONKEYQUEST_TITLE .. ": 设置为暴雪任务追踪器样式."
...
MONKEYQUEST_NOOBTIP_CLOSE				= "单击此处关闭主框架:"
MONKEYQUEST_NOOBTIP_MINIMIZE			= "单击此处最小化主框架"
MONKEYQUEST_NOOBTIP_RESTORE				= "单击此处还原主框架"
MONKEYQUEST_NOOBTIP_SHOWALLHIDDEN		= "单击此处显示所有隐藏项"
MONKEYQUEST_NOOBTIP_HIDEALLHIDDEN		= "单击此处隐藏所有隐藏项"
MONKEYQUEST_NOOBTIP_HIDEBUTTON			= "单击此处隐藏此任务。激活“显示所有隐藏项目”以再次查看此任务"
MONKEYQUEST_NOOBTIP_TITLE				= "右键单击此处打开MonkeyBuddy以便配置" .. MONKEYQUEST_TITLE
MONKEYQUEST_NOOBTIP_QUESTHEADER			= "单击此处隐藏/显示此区域下的所有任务。激活“显示所有隐藏项”以显示已隐藏的区域标题."

-- bindings
BINDING_NAME_MONKEYQUEST_CLOSE			= "关闭/打开"
BINDING_NAME_MONKEYQUEST_MINIMIZE		= "最小化/还原"
BINDING_NAME_MONKEYQUEST_HIDDEN			= "隐藏/显示所有隐藏项"
BINDING_NAME_MONKEYQUEST_NOHEADERS		= "切换标题"
