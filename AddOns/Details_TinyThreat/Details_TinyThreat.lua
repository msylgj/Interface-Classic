...
ThreatMeter:SetPluginDescription ("用于跟踪您和其他团队成员在当前目标中的仇恨的小工具.")
...
local build_options_panel = function()
	...
	local options_frame = ThreatMeter:CreatePluginOptionsFrame ("ThreatMeterOptionsWindow", "Tiny Threat设置", 1)
