...
-- 任务描述
	...
	if (CanSetFont(QuestFont)) then 		   			QuestFont:SetTextColor(1, 1, 1); end			-- 预设值：(0, 0, 0)
...
-- -----------------------------------------------------------------------------
	...
	if (CanSetFont(MailTextFontNormal)) then 		   	MailTextFontNormal:SetTextColor(1, 1, 1); end		-- 预设值：(0.18, 0.12, 0.06)
...
-- -----------------------------------------------------------------------------
	...
	if (CanSetFont(WorldMapTextFont)) then				WorldMapTextFont:SetFont(CLEAR_FONT, 62 * CF_SCALE, "THICKOUTLINE"); end	-- 预设值：102
...
-- -----------------------------------------------------------------------------
	...
	if (CanSetFont(InvoiceTextFontNormal)) then 	   	InvoiceTextFontNormal:SetTextColor(1, 1, 1); end	-- 预设值：(0.18, 0.12, 0.06)

	if (CanSetFont(InvoiceTextFontSmall)) then			InvoiceTextFontSmall:SetFont(CLEAR_FONT_QUEST, 11 * CF_SCALE); end	-- 预设值：10
	if (CanSetFont(InvoiceTextFontSmall)) then			InvoiceTextFontSmall:SetTextColor(1, 1, 1); end	-- 预设值：(0.18, 0.12, 0.06)
